...
namespace LPGxWebApp.Pages
{
    public class UserListModel : PageModel
    {
        ...
        public UserListModel(ILogger<UserListModel> logger, IConfiguration configuration, ApiService apiService)
        {
            _logger = logger;
        ...
        private async Task<bool> ReportCallApiAsync(string branchcode)
        {
            try
            {
                ...
                UserList = userListResponse.Where(u => u.USERLEVEL != 1).ToList();
